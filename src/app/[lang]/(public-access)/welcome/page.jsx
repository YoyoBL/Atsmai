...
const Welcome = () => {
   return (
      <section className="grid justify-items-center w-full">
         <div className="shadow-lg md:w-3/4 grid md:grid-cols-12 place-items-center gap-1 p-5">
            <div className="col-span-7">
               <h1 className="text-3xl text-center">Welcome to Atsmai</h1>
               <div className="p-3 md:w-3/4"></div>
               <p>
                  Welcome to our income and expense management application!{" "}
                  <br />
            ...
            <div className="grid place-items-center h-full col-span-4 md:text-center">
